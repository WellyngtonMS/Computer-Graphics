...
void Display(void) {
    ...
    // Matriz View ////////////////////////////////////////////////////////////
    // You will have to change the contents of this matrix for the exercises
    glm::vec3 camera_alvo = glm::vec3(0.0f, 0.0f, -1.0f);
    glm::vec3 camera_pos = glm::vec3(-0.1f, 0.1f, 0.1f);
    glm::vec3 camera = glm::vec3(0.0f, 1.0f, 0.0f);

    glm::vec3 camera_z = -glm::normalize(camera_alvo - camera_pos);
    glm::vec3 camera_x = glm::normalize(glm::cross(camera, camera_z));
...
int main(int argc, char** argv) {
    ...
    char auxA[] = "vertex_shader.glsl";
    LoadShader(auxA, &vertex_shader_source);
    ...
    char auxB[] = "fragment_shader.glsl";
    LoadShader(auxB, &frag_shader_source);
